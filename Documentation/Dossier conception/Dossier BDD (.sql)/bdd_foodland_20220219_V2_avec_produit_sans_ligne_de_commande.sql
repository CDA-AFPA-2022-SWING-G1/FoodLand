...
DROP DATABASE IF EXISTS foodland_avec_produit_sans_ligne_de_commande;

CREATE DATABASE foodland_avec_produit_sans_ligne_de_commande;

USE foodland_avec_produit_sans_ligne_de_commande;
...
-- JEUX DE DONNÉES FOODLAND
-- C’est ici les produits car produit == facture
        -- Comment hériter de la table produit ?
        -- Quand accepter_ou_refuser_commande BOOLEAN NULL (de la table commande), est TRUE càd == commande ou livraison acceptée
