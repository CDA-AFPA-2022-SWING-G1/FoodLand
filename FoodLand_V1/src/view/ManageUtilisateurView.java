...
public class ManageUtilisateurView extends JFrame implements ListSelectionListener {
	...
	public ManageUtilisateurView() {
		...
		lblPassword.setBounds(10, 525, 70, 14);
		...
		tfPassword.setBounds(110, 522, 134, 20);
...
//					}
					...
					Vector<Utilisateur> listUtilisateur = new Vector(controlUtilisateur.lister());
...
//						 icone = new ImageIcon(newimg);
		...
		lblChoixRole.setBounds(10, 439, 86, 14);
		...
		comboBoxRole.setBounds(110, 435, 134, 22);
		...
		lblAssocierCompte.setBounds(10, 471, 234, 14);
		desktopPane.add(lblAssocierCompte);
		
		JLabel lblLibelCompte = new JLabel("Libell\u00E9 compte:");
		lblLibelCompte.setBounds(10, 496, 86, 14);
		desktopPane.add(lblLibelCompte);
		
		textField = new JTextField();
		textField.setBounds(110, 496, 134, 20);
