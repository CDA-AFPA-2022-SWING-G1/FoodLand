...
import controller.Liste_des_commandes_a_preparerControl;
public class Liste_des_commandes_a_preparerView {
	
	Liste_des_commandes_a_preparerView() throws SQLException
	{
		/*JFrame frame;*/
		...
		Vector<String> rowHeader = new Vector<String> ();      
		  ...
		  Liste_des_commandes_a_preparerControl commandes = new Liste_des_commandes_a_preparerControl();  
